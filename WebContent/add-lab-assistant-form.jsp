...
<body>
    ...
    <div id="container">
         ...
         <form name ="myform" action="LabAssistantControllerServlet" method="GET" data-parsley-validate="">
               ...
               <table>
                   <tbody>
				      ...
				      <tr>
				          ...
				          <td><input type="text" name="salary" required data-parsley-type="digits"/></td>
				     </tr>
